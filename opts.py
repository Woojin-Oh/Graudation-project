...
def parse_opts():
    ...
    parser.add_argument('--midas_input_path',
                        default=None,
                        help='Folder with input images (if no input path is specified, images are tried to be grabbed '
                             'from camera)'
                        )

    parser.add_argument('--midas_output_path',
                        default=None,
                        help='Folder for output images'
                        )

    parser.add_argument('--midas_weights',default=None,help='Path to the trained weights of model'
                        )

    parser.add_argument('--midas_model_type',
