...
if __name__ == '__main__':
    ...
    label_csv_path = os.path.join(csv_dir_path, 'classIndBinary.txt')
    train_csv_path = os.path.join(csv_dir_path, 'trainlist01_binary.txt')
    val_csv_path = os.path.join(csv_dir_path, 'vallist01_binary.txt')
    dst_json_path = os.path.join(csv_dir_path, 'jester_binary.json')
