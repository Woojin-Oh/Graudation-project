...
def convert_nv_csv_to_activitynet_json(label_csv_path, 
...
if __name__ == '__main__':
    ...
    csv_dir_path = 'C:/Users/Admin/Desktop/Hololens_dataset'
    #for class_type in ['all', 'all_but_None', 'binary']:
    for class_type in ['binary']:
        ...
        val_csv_path = os.path.join(csv_dir_path, 'vallist'+ class_type + '.lst')
        dst_json_path = os.path.join(csv_dir_path, 'nv' + class_type + '.json')

        convert_nv_csv_to_activitynet_json(label_csv_path,
                                               val_csv_path, dst_json_path)
